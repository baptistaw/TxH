...
const testPostops = [
  ...
  {
    caseIndex: 0,
    evaluationDate: new Date('2024-03-16'), // 1 día post-trasplante
    icuDays: 3,
    wardDays: 12,
    ...
    otherComplications: 'Evolución favorable sin complicaciones',
  },
  // Caso 2
  {
    caseIndex: 1,
    evaluationDate: new Date('2024-06-21'), // 1 día post-trasplante
    icuDays: 7,
    wardDays: 14,
    ...
    vascularComplications: false,
    surgicalBleeding: false,
    otherComplications: 'Insuficiencia renal transitoria, requirió hemodiálisis',
  },
];
